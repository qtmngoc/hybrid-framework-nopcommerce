...
import static reportConfig.wordPress.WpExtentTestManagerV5.getTest;
...
public class WpExtentTestListenerV5 extends WpBaseTest implements ITestListener {
	...
	public void onFinish(ITestContext iTestContext) {
		WpExtentManagerV5.extentReports.flush();
	}
	...
	public void onTestFailure(ITestResult iTestResult) {
		...
		WebDriver driver = ((WpBaseTest) testClass).getDriverInstance();
