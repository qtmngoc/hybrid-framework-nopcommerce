...
//import pageUIs.facebook.BasePageUI;

public class FbBasePage {

	public static FbBasePage getBasePage() {
		return new FbBasePage();
	}
	...
	protected WebDriverWait explicitWait(WebDriver driver, long timeout) {
	...
	protected void sendKeypressToElement(WebDriver driver, String xpathLocator, Keys key) {
		Actions action = new Actions(driver);
		action.sendKeys(waitForElementVisible(driver, xpathLocator), key).perform();
	}
	
	protected void sendKeypressToElement(WebDriver driver, String dynamicXpath, Keys key, String... dynamicValues) {
		Actions action = new Actions(driver);
	...
	/*public void uploadMultipleFiles(WebDriver driver, String... fileNames) {
		String filePath = FbGlobalConstants.UPLOAD_FILES;	
		String fullFileName = "";
	...
	private long longTimeout = FbGlobalConstants.LONG_TIMEOUT;
	private long shortTimeout = FbGlobalConstants.SHORT_TIMEOUT;
