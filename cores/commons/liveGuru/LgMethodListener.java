...
public class LgMethodListener implements IInvokedMethodListener {
	@Override
	...
	public void afterInvocation(IInvokedMethod method, ITestResult result) {
		...
		if (method.isTestMethod()) {
			LgVerificationFailures allFailures = LgVerificationFailures.getFailures();
	...
	private static final Log log = LogFactory.getLog(LgMethodListener.class);
}
