...
public class NcBaseTest {
	...
	protected WebDriver getBrowserDriver(String browserName) {
		NcBrowserList browser = NcBrowserList.valueOf(browserName.toUpperCase());
		...
		driver.manage().timeouts().implicitlyWait(NcGlobalConstants.LONG_TIMEOUT, TimeUnit.SECONDS);
		driver.get(NcGlobalConstants.USER_PAGE_URL);
		return driver;
	}
	...
	protected boolean verifyTrue(boolean condition) {
		...
		try {
			...
			NcVerificationFailures.getFailures().addFailureForTest(Reporter.getCurrentTestResult(), e);
