...
public class NcMethodListener implements IInvokedMethodListener {
	@Override
	...
	public void afterInvocation(IInvokedMethod method, ITestResult result) {
		...
		if (method.isTestMethod()) {
			NcVerificationFailures allFailures = NcVerificationFailures.getFailures();
	...
	private static final Log log = LogFactory.getLog(NcMethodListener.class);
}
