...
import pageUIs.jQuery.uploadFiles.JqBasePageUI;

public class JqBasePage {

	public static JqBasePage getBasePage() {
		return new JqBasePage();
	}
	...
	public void uploadMultipleFiles(WebDriver driver, String... fileNames) {
		String filePath = JqGlobalConstants.UPLOAD_FILES;	
		String fullFileName = "";
		for (String file : fileNames) {
			fullFileName = fullFileName + filePath + file + "\n";
		}
		fullFileName = fullFileName.trim();
		getElement(driver, JqBasePageUI.UPLOAD_FILE).sendKeys(fullFileName);
	}
	...
	private long longTimeout = JqGlobalConstants.LONG_TIMEOUT;
	private long shortTimeout = JqGlobalConstants.SHORT_TIMEOUT;
