...
public class JqMethodListener implements IInvokedMethodListener {
	@Override
	...
	public void afterInvocation(IInvokedMethod method, ITestResult result) {
		...
		if (method.isTestMethod()) {
			JqVerificationFailures allFailures = JqVerificationFailures.getFailures();
	...
	private static final Log log = LogFactory.getLog(JqMethodListener.class);
}
