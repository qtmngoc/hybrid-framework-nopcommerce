...
public class Demo_01_Login extends WpBaseTest {
	...
	public void Login_02_Not_Existent_Username(Method method) {
		...
		WpExtentTestManagerV5.getTest().log(Status.INFO, "Step 04: Verify 'User does not exist. Would you like to create a new account?' message is displayed.");
	...
	public void Login_03_Incorrect_Password(Method method) {
		...
		WpExtentTestManagerV5.getTest().log(Status.INFO, "Step 06: Verify 'Oops, that's not the right password. Please try again!' message is displayed.");
	...
	public void Login_04_Success(Method method) {
		...
		WpExtentTestManagerV5.getTest().log(Status.INFO, "Step 06: Verify 'Dashboard' header is displayed.");
