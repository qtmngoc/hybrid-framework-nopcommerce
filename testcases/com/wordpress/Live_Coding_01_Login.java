...
public class Live_Coding_01_Login extends BaseTest {
	...
	public void Login_01_Empty_Username(Method method) {
		...
		ExtentTestManagerV5.getTest().log(Status.INFO, "Step 01: Enter empty value into Username textbox.");
	...
	public void Login_02_Not_Existent_Username(Method method) {
		...
		ExtentTestManagerV5.getTest().log(Status.INFO, "Step 02: Enter '" + nonExistentUsername + "' into Username textbox.");
	...
	public void Login_03_Incorrect_Password(Method method) {
		...
		ExtentTestManagerV5.getTest().log(Status.INFO, "Step 02: Enter '" + username + "' into Username textbox.");
	...
	public void Login_04_Success(Method method) {
		...
		ExtentTestManagerV5.getTest().log(Status.INFO, "Step 02: Enter '" + username + "' into Username text box.");
		adminLoginPage.inputIntoUsernameTextbox(username);
