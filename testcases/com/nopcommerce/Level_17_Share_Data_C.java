...
public class Level_17_Share_Data_C extends NcBaseTest {
	...
	public void beforeClass(String browserName) {
		...
		log.info("Pre-condition - Step 11: Set cookies and reload page");
		userLoginPage.setCookies(driver, Common_01_Register_Cookie.loggedCookies);
		userLoginPage.refreshCurrentPage(driver);
		
		log.info("Pre-condition - Step 12: Verify My Account link is displayed");
		verifyTrue(userHomePage.isMyAccountLinkDisplayed());

		log.info("Pre-condition - Step 13: Navigate to Search page");
		userSearchPage = userHomePage.clickOnSearchLink();

		log.info("Pre-condition - Step 14: Verify Search header is displayed");
